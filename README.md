...
- ```gene_coverage_specificity.py``` > script for calculating gene coverage lineage. Input files are GTDB taxonomy per genome & eggnog-mapper gene functional annotations
